        ...
        private function register_constructor_hooks() {
            ...
            if ( $this->is_plugin() ) {
                if ( $this->_is_network_active ) {
                    ...
                    add_action( 'wp_initialize_site', array( $this, '_after_new_blog_callback_new' ), 10, 2 );
                }
...
//				$this->sync_install( array(), true );
         ...
         */
        function _after_new_blog_callback_new( $site, $args ) {
            $this->_after_new_blog_callback( $site->blog_id, $args['user_id'], $site->domain, $site->path, $site->network_id, $args['options'] ); 
        }
