<?php
/**
 * Plugin Name: Gravity Perks |  VestaThemes.com
...
define( 'GRAVITY_PERKS_VERSION', '2.1.7' );
...
class GravityPerks {
    ...
    */
    ...
    public static function flush_license( $hard = false ) {
	    ...
	    delete_transient( 'gwapi_get_dashboard_announcements' );
	    delete_transient( 'gwapi_get_products' );
    }
    ...
    */
	...
	private static function get_current_page() {
		return $current_page = trim( strtolower( rgget( 'page' ) ) );
	}
