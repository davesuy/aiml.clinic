...
//			),
	...
	public function get_expired_entries() {
		...
		$exp_mod    = GPNF_Entry::get_expiration_modifier();
		$expiration = strtotime( sprintf( '-%d seconds', $exp_mod ) );

		$this->log( sprintf( 'Expiration Modifier: %d', $exp_mod ) );
	...
	public function get_all_entries_markup( $field, $value, $modifiers, $is_all_fields, $format = 'html' ) {
		...
		$hr = $format == 'html' ? '<hr class="gpnf-nested-entries-hr" style="height:12px;visibility:hidden;margin:0;">' : "---\n\n";
